...
import com.example.todomvvm.screens.tasks.viewmodel.DeleteAllViewModel;
...
public class TaskListActivity extends AppCompatActivity implements TaskAdapter.ItemClickListener {
    ...
    DeleteAllViewModel deleteAllViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteAllViewModel =  ViewModelProviders.of(this).get(DeleteAllViewModel.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.supportUS:
                Intent implicitIntent= new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/mayor1303"));
        ...
        final AlertDialog alertDialog= new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        final List<TaskEntry> todoList = mAdapter.getTasks();
                        deleteAllViewModel.deleteAllTasks();
                        todoList.clear();
                        mAdapter.setTasks(todoList);
                        mAdapter.notifyDataSetChanged();
                    }
